...
//#define CONFIG_DM9000_BASE		(0xA8000000)			// Bank5
#define CONFIG_DM9000_BASE		(0x88000300)				// Bank1
...
#define CFG_PROMPT              "XIAOV210 # "   /* Monitor Command Prompt       */
...
#define CONFIG_IDENT_STRING	" for XIAO210"
